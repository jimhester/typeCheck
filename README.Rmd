...
## Type Check ##
[![Travis-CI Build Status](https://travis-ci.org/jimhester/typeCheck.svg?branch=
master)](https://travis-ci.org/jimhester/typeCheck)
[![Coverage Status](https://img.shields.io/codecov/c/github/jimhester/typeCheck/
master.svg)](https://codecov.io/github/jimhester/typeCheck?branch=master)
